...
<div class="body_wrapper body_color">
    <table class="table table-hover">
        ...
        if (!$rows) {
            ?>
            <td><p>The  installment or period you entered is not correct. you can use installment:500 TK, 1000 TK, 2000 TK and 5000 TK<br/> And you can use period:3 years, 5 years, and 10 years.</p></td>
            <?php
        } else {
            ?>
